...
void TupleCellSpec::aggr_to_string(const AggrOp aggr_, std::string &aggr_repr)
{
  if (aggr_ == AggrOp::AGGR_SUM) {
    aggr_repr = "SUM";
  }
  if (aggr_ == AggrOp::AGGR_MAX) {
    aggr_repr = "MAX";
  }
  if (aggr_ == AggrOp::AGGR_MIN) {
    aggr_repr = "MIN";
  }
  if (aggr_ == AggrOp::AGGR_AVG) {
    aggr_repr = "AVG";
  }
  if (aggr_ == AggrOp::AGGR_COUNT) {
    aggr_repr = "COUNT";
  }
}
